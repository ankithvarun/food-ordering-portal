...
const BuyerOrders = (props) => {
  ...
  useEffect(() => {
    ...
    axios
      .post("http://localhost:4000/order/search", Email)
      .then((response) => {
  ...
  const HandlePickup = (order, ind) => {
    ...
    axios 
      .post("http://localhost:4000/order/stage", Order)
      .then((response) => {
  ...
  const updateRating = () => {
    ...
    axios 
      .post("http://localhost:4000/fooditem/updaterating", Item)
      .then((response) => {
        let temp = isRated;
        setRating(0);
        setIsRated(false);
    ...
    axios 
      .post("http://localhost:4000/order/update", Order)
      .then((response) => {
