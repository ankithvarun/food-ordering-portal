...
const VendorsList = (props) => {
  ...
  useEffect(() => {
    ...
    axios
      .post("http://localhost:4000/fooditem", Canteen)
      .then((response) => {
  ...
  const handleItemUpdate = (item) => {
    ...
    axios
      .post("http://localhost:4000/fooditem/updateitem", foodItem)
      .then((response) => {
  ...
  const handleItemDelete = (item) => {
    ...
    axios
      .post("http://localhost:4000/fooditem/deleteitem", foodItem)
      .then((response) => {
  ...
  const handleAddItem = () => {
    ...
    axios
      .post("http://localhost:4000/fooditem/additem", foodItem)
      .then((response) => {
  ...
  const updateTag = (item) => {
    ...
    axios
      .post("http://localhost:4000/fooditem/updatetags", foodItem)
      .then((response) => {
        setUpdateState(false);
  ...
  const updateAddon = (item) => {
    ...
    axios
      .post("http://localhost:4000/fooditem/updateaddons", foodItem)
      .then((response) => {
        setUpdateState(false);
